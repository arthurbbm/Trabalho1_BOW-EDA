...
void menu(void)//O(1)
{
	...
	puts ("\t |       4. Imprimir BOW TRA e TRB                  |");//O(1)
	puts ("\t |       5. Imprimir distancia Euclidiana           |");//O(1)
	puts ("\t |       6. Exibir tabela                           |");//O(1)
	puts ("\t |       0. Sair                                    |");//O(1)
	puts ("\t |                                                  |");//O(1)
    puts ("\t +--------------------------------------------------+");//O(1)
    puts ("\t +--------------------------------------------------+");//O(1)
	puts ("\t | 		--> INSTRUCOES: <--     	    |");//O(1)
    puts ("\t +--------------------------------------------------+");//O(1)
	puts ("\t |     ** Eh necessario primeiramente **  	    |");//O(1)
	puts ("\t |     ** escolher opcoes 1. 2. e 3.  ** 	    |");//O(1)
	puts ("\t |     ** para execucao correta	      **	    |");//O(1)
    puts ("\t +--------------------------------------------------+");//O(1)
